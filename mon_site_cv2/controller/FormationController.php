...
class FormationController
{
    ...
    {
        $this->db = new \model\FormationManager; // permet de récupérer une connexion à la BDD qui se trouve dans le fichier EntityRepository.php
    }
    ...
    public function selectAll()
    {
        ...
        $this->render('layout.php', 'donnees.php', array(
            ...
            'id' => 'id_' . $this->db->table2 // affiche idEmploye, cela servira a pointé sur l'indice idEmploye du tableau de données envoyer dans le layout pour les liens voir/modifier/supprimer
        ));
    }
