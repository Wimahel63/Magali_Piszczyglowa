...
class UserFormManager
{
    ...
    public function select($id) // méthode permettant de récupérer les données d'un element via son id
    {
    ...
    public function selectAll()
    {
        ...
        $q = $this->getDb()->query("SELECT prenom, nom, pseudo, email, avatar, age, date_naissance, ville, pays FROM " . $this->table5); //  requete permettant de selectionner toute une table, $this->table5 : représente dans notre cas la table 't_user'
        $r = $q->fetchAll(\PDO::FETCH_ASSOC); 
        return $r;
    }
